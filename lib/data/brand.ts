...
export const brand = {
  ...
  seo: {
    title: "KICKVERSE KE | HOME OF THE BEST SNEAKERS", //
  ...
  hero: {
    ...
    headlineHighlight: "SNEAKERS", //
    backgroundImage: "/IMG-20260719-WA0006.jpg", //
  ...
  sections: {
    featured: {
      ...
      subtitle: "Browse our curated selection of genuine quality sneakers." //
    },
    flashDeals: {
      badge: "Live Offers",
      title: "Flash Deals",
...
export const announcementMessages = [
  ...
  { text: "HOME OF THE BEST SNEAKERS", icon: Sparkles }, //
