    ...
    <div className="h-full w-full max-w-4xl mx-auto p-4 sm:p-6 flex flex-col overflow-hidden">
      ...
      <div className="flex-1 min-h-0 overflow-auto scrollbar-hide bg-brand-card rounded-md border border-white/5">
        <form onSubmit={handleSubmit} className="space-y-6 p-4 sm:p-6">
          ...
          {/* Media Mapping Integration UI */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            
            {/* Main Image Setup */}
            <div className="bg-brand-dark p-6 rounded-md border border-white/5 space-y-4">
              <label className="block text-xs font-bold uppercase tracking-widest text-gray-400">Main Image (Required)</label>
              {mainImageUrl ? (
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <input type="file" name="mainImage" accept="image/*" required={!mainImageUrl} className="text-sm text-gray-400 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-bold file:bg-white/10 file:text-white hover:file:bg-white/20 transition-colors cursor-pointer" />
                </div>
              )}
            ...
            {/* Gallery Setup */}
            <div className="bg-brand-dark p-6 rounded-md border border-white/5 space-y-4">
              <label className="block text-xs font-bold uppercase tracking-widest text-gray-400">Gallery Images (Optional)</label>
