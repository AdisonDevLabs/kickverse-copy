      ...
      */}
      <section ref={heroRef} className="relative min-h-[100svh] w-full flex flex-col justify-center overflow-hidden bg-black pt-[80px] md:pt-[87px] pb-[88px] md:pb-0">
        ...
        >
            ...
            <motion.p 
              variants={staggerItem}
              className="text-gray-100 sm:text-gray-300 text-[13px] sm:text-sm md:text-base max-w-[480px] sm:max-w-lg mb-5 sm:mb-6 font-medium leading-relaxed drop-shadow-xl shadow-black mx-auto"
            >
              {brand.description}
            </motion.p>
