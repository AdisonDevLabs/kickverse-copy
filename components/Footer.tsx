    ...
    <footer className="bg-brand-dark border-t border-white/10 pt-20 pb-8 relative z-20">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          {/* Brand Section */}
          <motion.div variants={staggerItem} className="md:col-span-6 lg:col-span-4 flex flex-col items-start text-left">
            {/* FIXED: Changed tracking-tighter to tracking-widest to prevent letters from stacking and ensure readability */}
          ...
          {/* Quick Links Group (Side-by-side on mobile & tablet for seamless fit) */}
          ...
          {/* Contact & Community Group (Dynamically splits rows across devices to eliminate dead space) */}
          <motion.div variants={staggerItem} className="md:col-span-12 lg:col-span-4">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-10 lg:gap-0">
              
              {/* Left Col (Tablet): Contact Links */}
              ...
              {/* Right Col (Tablet): Community & Socials */}
              <div className="flex flex-col">
                {/* WhatsApp Community */}
                <div className="pt-8 md:pt-0 lg:pt-8 border-t border-white/5 md:border-t-0 lg:border-t mb-8 lg:mt-8">
                  <h4 className="font-bold text-white text-sm uppercase tracking-wider mb-2">Join Our Community</h4>
                  <p className="text-gray-400 text-xs mb-4 max-w-sm">Get early access to new arrivals, exclusive flash deals, and restock updates.</p>
